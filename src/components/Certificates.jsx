  ...
  return (
    ...
    >
      ...
      <div className="p-5" style={{ transform: 'translateZ(20px)' }}>
        ...
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.9rem', color: 'rgba(255,255,255,0.45)', lineHeight: 1.6, marginBottom: 14, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
          {cert.description}
        </p>
        ...
        <div className="flex flex-wrap gap-1.5 mb-5">
          {cert.skills.map(s => (
            <span key={s} style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '0.45rem', letterSpacing: '0.1em', padding: '3px 10px', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 999, color: 'rgba(255,255,255,0.5)' }}>
              {s}
            </span>
          ))}
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          <div className="relative">
            <button
              ...
              style={{ background: 'rgba(255,255,255,0.04)', borderColor: 'rgba(255,255,255,0.1)', fontFamily: 'Space Grotesk, sans-serif', fontSize: '0.55rem', letterSpacing: '0.15em', color: 'rgba(255,255,255,0.7)', minWidth: 160 }}
            >
        ...
        <div ref={gridRef}>
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 gap-6">
              ...
              <div style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '0.65rem', letterSpacing: '0.2em', color: 'rgba(255,255,255,0.25)' }}>
                NO CERTIFICATES FOUND
              </div>
              <p style={{ fontFamily: 'Inter, sans-serif', color: 'rgba(255,255,255,0.2)', fontSize: '0.9rem' }}>
