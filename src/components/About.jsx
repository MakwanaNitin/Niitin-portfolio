  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-yellow-900/10 blur-[120px] rounded-full mix-blend-screen" />
      ...
      <div className="max-w-[90rem] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          {/* Masked Overlay: Batman (Hover to reveal) */}
          <div 
            ref={maskRef}
        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <h2 className="stagger-reveal text-5xl md:text-6xl font-bold tracking-tighter text-white font-sans leading-tight">
              The Dual <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-gray-400 font-serif italic pr-4">Identity</span>
            </h2>
          </div>

          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              I am a dedicated software developer with a strong interest in Android development, Flutter, full-stack web development, and UI/UX design. I completed my Bachelor of Computer Applications (BCA) from Marwadi University and am currently pursuing my Master of Computer Applications (MCA). I enjoy solving real-world problems by building efficient and scalable applications.
            </p>
          </div>
            ...
            <div className="stagger-reveal grid grid-cols-2 gap-x-8 gap-y-4 pt-4 border-t border-white/10 max-w-xl">
              {[
                ...
                <div key={i} className="flex items-center space-x-3 group">
                  <div className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-yellow-400 transition-colors duration-300" />
          ...
          <div className="overflow-hidden mt-6">
            <blockquote className="stagger-reveal border-l-2 border-yellow-500/50 pl-6 py-2">
